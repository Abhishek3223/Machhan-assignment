  ...
  return (
    ...
    >
      <div className="container mx-auto flex items-center justify-between h-full">
        <Link to={"/"}>
          <div className="w-[50px] font-bold">
            machann<span className="text-red-900">.demo</span>
          </div>
        </Link>
...

        {
          !isLoggedIn ?
            <Link to='/auth'>
              <div className="bg-black text-white font-bold text-md hover:bg-gray-700 p-2 ">Get in</div>
            </Link>
            :
